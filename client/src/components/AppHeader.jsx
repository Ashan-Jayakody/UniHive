...
const AppHeader = ({ title = 'UniHive', subtitle = '', showBackHome = true }) => {
  ...
  return (
    <>
      <aside className="fixed inset-y-0 left-0 z-40 flex w-56 flex-col bg-gradient-to-br from-blue-700 via-blue-600 to-emerald-600 border border-white/10 shadow-2xl text-white">
